...
public class Main {
	...
	public static void main(String[] args) {
		...
		Warrior w1 = wc.getRandomWarrior();
		Player user = new Player(w1, "user");
		user.setWeapon();

		Warrior w2 = wc.getRandomWarrior();
		Player cpu = new Player(w2, "cpu");
		cpu.setWeapon();

		new BattleGUI(user, cpu, wc, "BatallaDeRazas/src/background/night.jpg");
	}
